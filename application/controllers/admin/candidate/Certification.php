...
class Certification extends CI_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('candidate/Certification_model', 'model_certification');
	...
	public function index(){
		...
		if($this->valid){
			$certifications = $this->model_certification->getCertifications($this->candidate_id);
			if($certifications) {
	...
	public function add(){
		...
		$json = array();
		if($this->valid){
			$certification_id = $this->model_certification->addCertification($this->candidate_id);
			if($certification_id) {
