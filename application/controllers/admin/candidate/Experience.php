...
class Experience extends CI_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('candidate/Experience_model', 'model_experience');
    ...
    public function index(){
        ...
        if($this->valid){
            $experiences = $this->model_experience->getExperiences($this->candidate_id);
            if($experiences) {
	...
	public function add(){
		...
		$json = array();
		if($this->valid){
			$experience_id = $this->model_experience->addExperience($this->candidate_id);
			if($experience_id) {
