...
class Jobcategory extends CI_Controller {
    ...
    public function index(){
		...
		$data['breadcrumb'][] = array(
			'name' => 'Job Category',
			'href' => base_url() . 'admin/jobcategory'
		);
		$data['active_menu'] = 'mnu-jobcategory';
		...
		$config['base_url'] = base_url() . 'admin/category/jobcategory/index/';
		...
		$this->load->view('admin/category/job_category');
