$(function(){
    ...
    function loadProfileSummary() {
      $.ajax({
        url: formUrl('admin/candidate/profile/summary', {candidate_id:candidate_id}),
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
      ...
      $.ajax({
        ...
        success: function(res) {
          if(res.success) {
            ...
            $('#formProfileSummary').attr('action', formUrl('admin/candidate/profile/summary/edit', {candidate_id:candidate_id}));
