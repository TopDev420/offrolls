(function($) {
  ...
  $(function(){
    ...
    function loadSkills() {
      $.ajax({
        url: formUrl('admin/candidate/profile/skills', {candidate_id:candidate_id}),
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    function saveSkill(form) {
      ...
      $.ajax({
        url: base_url + 'admin/candidate/profile/skills/edit',
        type: 'post',
        data: form.serialize(),
        dataType: 'json',
        beforeSend: function() {
    ...
    $(document).on('click', '#edit-skills', function(e){
      ...
      $.ajax({
        url: base_url + 'admin/candidate/profile/skills',
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
