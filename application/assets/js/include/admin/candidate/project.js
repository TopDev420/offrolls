$(function(){
    ...
    function loadProjects() {
      $.ajax({
        url: formUrl('admin/candidate/project', {candidate_id:candidate_id}),
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    $('#add-project').click(function(e){
      ...
      $('#formProject').attr('action', formUrl('admin/candidate/project/add', {candidate_id:candidate_id}));
    ...
    $(document).on('click', '.edit-project', function(e){
      ...
      if(cpid != '' && typeof(cpid) != 'undefined'){
        $.ajax({
          url: formUrl('admin/candidate/project/detail/' + cpid, {candidate_id:candidate_id}),
          type: 'post',
          data: {view: 1},
          dataType: 'json',
          beforeSend: function() {
          ...
          success: function(res) {
            if(res.success) {
              ...
              $('#formProject').attr('action', formUrl('admin/candidate/project/edit/' + cpid, {candidate_id:candidate_id}));
    ...
    $(document).on('click', '.delete-project', function(e){
      ...
      $('#formDeleteProject').submit(function(e){
        ...
        var button_txt = $form.find('button[type=submit]').html();
        $.ajax({
          url: formUrl('admin/candidate/project/delete/' + cpid, {candidate_id:candidate_id}),
          type: 'post',
          dataType: 'json',
          beforeSend: function() {
            $form.find('button[type=submit]').html(loading_txt).attr('disabled', true);
