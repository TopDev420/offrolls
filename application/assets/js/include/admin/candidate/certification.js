$(function(){
    ...
    function loadCertifications() {
      $.ajax({
        url: formUrl('admin/candidate/certification', {candidate_id:candidate_id}),
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    $('#add-certification').click(function(e){
      ...
      $('#formCertification').attr('action', formUrl('admin/candidate/certification/add', {candidate_id:candidate_id}));
    ...
    $(document).on('click', '.edit-certification', function(e){
      ...
      if(cid != '' && typeof(cid) != 'undefined'){
        $.ajax({
          url: formUrl('admin/candidate/certification/detail/' + cid, {candidate_id:candidate_id}),
          type: 'post',
          data: {view: 1},
          dataType: 'json',
          beforeSend: function() {
          ...
          success: function(res) {
            if(res.success) {
              ...
              $('#formCertification').attr('action', formUrl('admin/candidate/certification/edit/' + cid, {candidate_id:candidate_id}));
    ...
    $(document).on('click', '.delete-certification', function(e){
      ...
      $('#formDeleteCertification').submit(function(e){
        ...
        var button_txt = $form.find('button[type=submit]').html();
        $.ajax({
          url: formUrl('admin/candidate/certification/delete/' + cid, {candidate_id:candidate_id}),
          type: 'post',
          dataType: 'json',
          beforeSend: function() {
            $form.find('button[type=submit]').html(loading_txt).attr('disabled', true);
