$(function(){
    ...
    function loadDesiredCareerDetail() {
      $.ajax({
        url: formUrl('admin/candidate/profile/career', {candidate_id:candidate_id}),
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
      ...
      $.ajax({
        ...
        success: function(res) {
          if(res.success) {
            ...
            $('#formDesiredCareerDetail').attr('action', formUrl('admin/candidate/profile/career/edit', {candidate_id:candidate_id}));
