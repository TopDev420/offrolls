$(function(){
    ...
    function loadCertifications() {
      $.ajax({
        url: formUrl('admin/freelancer/certification', {freelancer_id:freelancer_id}),
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    $('#add-certification').click(function(e){
      ...
      $('#formCertification').attr('action', formUrl('admin/freelancer/certification/add', {freelancer_id:freelancer_id}));
    ...
    $(document).on('click', '.edit-certification', function(e){
      ...
      if(cid != '' && typeof(cid) != 'undefined'){
        $.ajax({
          url: formUrl('admin/freelancer/certification/detail/' + cid, {freelancer_id:freelancer_id}),
          type: 'post',
          data: {view: 1},
          dataType: 'json',
          beforeSend: function() {
          ...
          success: function(res) {
            if(res.success) {
              ...
              $('#formCertification').attr('action', formUrl('admin/freelancer/certification/edit/' + cid, {freelancer_id:freelancer_id}));
    ...
    $(document).on('click', '.delete-certification', function(e){
      ...
      $('#formDeleteCertification').submit(function(e){
        ...
        var button_txt = $form.find('button[type=submit]').html();
        $.ajax({
          url: formUrl('admin/freelancer/certification/delete/' + cid, {freelancer_id:freelancer_id}),
          type: 'post',
          dataType: 'json',
          beforeSend: function() {
            $form.find('button[type=submit]').html(loading_txt).attr('disabled', true);
