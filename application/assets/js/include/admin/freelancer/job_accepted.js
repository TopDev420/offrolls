$(function(){
    var href_loadAcceptedJobs = formUrl('admin/freelancer/job/getAcceptedJobs', {freelancer_id:freelancer_id});
                            ...
                            '<div class="col-12 pt-5">' +
                                '<div class="d-flex">' +
                                    '<div class="user-info d-block w-100">' +
                                        '<div class="row mb-4">' +
                                            '<div class="col-md-8">' +
                                                '<h5 class="font-500"><a href="'+ job.accepted_job +'" class="title-h5">'+ job.title +' </a></h5>' +
                                            '</div>' +
