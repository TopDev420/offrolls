$(function(){
    ...
    function loadEducations() {
      $.ajax({
        url: formUrl('admin/freelancer/education', {freelancer_id:freelancer_id}),
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    $('#add-education').click(function(e){
      ...
      $('#formEducation').attr('action', formUrl('admin/freelancer/education/add', {freelancer_id:freelancer_id}));
    ...
    $(document).on('click', '.edit-education', function(e){
      ...
      if(ceid != '' && typeof(ceid) != 'undefined'){
        $.ajax({
          url: formUrl('admin/freelancer/education/detail/' + ceid, {freelancer_id:freelancer_id}),
          type: 'post',
          data: {view: 1},
          dataType: 'json',
          beforeSend: function() {
          ...
          success: function(res) {
            if(res.success) {
              ...
              $('#formEducation').attr('action', formUrl('admin/freelancer/education/edit/' + ceid, {freelancer_id:freelancer_id}));
    ...
    $(document).on('click', '.delete-education', function(e){
      ...
      $('#formDeleteEducation').submit(function(e){
        ...
        var button_txt = $form.find('button[type=submit]').html();
        $.ajax({
          url: formUrl('admin/freelancer/education/delete/' + ceid, {freelancer_id:freelancer_id}),
          type: 'post',
          dataType: 'json',
          beforeSend: function() {
            $form.find('button[type=submit]').html(loading_txt).attr('disabled', true);
