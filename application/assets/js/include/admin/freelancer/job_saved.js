$(function(){
    var href_loadSavedJobs = formUrl('admin/freelancer/job/getSavedJobs', {freelancer_id:freelancer_id});
    ...
    function loadSavedJobsView(elementBlock,jobs){
        ...
        if($.isArray(jobsList) && jobsList.length > 0){
                                        ...
                                        '<div class="info info-content">' +
                                            '<div class="row">' +
                                                '<div class="col-12">' +
                                                    ...
                                                    '<p class="m-0 short--view">'+ job.description +' </p>' +
                                                '</div>' +
                                                '<br>' +
                                                '<div class="col-12">' +
                                                    jSkills +
            ...
            $('.short--view').showMore({
                ...
                buttontxtmore: '...more',
                buttontxtless: '...less',
                buttoncss: 'font-500 secondary-color',
                animationspeed: 250
            });
