$(function(){
    ...
    var formProject = $('#formProject').validate({
        ...
        messages: {
          ...
          project_url: "Please enter project url",
    ...
    function loadProjects() {
      $.ajax({
        url: formUrl('admin/freelancer/project', {freelancer_id:freelancer_id}),
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
    ...
    $('#add-project').click(function(e){
      ...
      $('#formProject').attr('action', formUrl('admin/freelancer/project/add', {freelancer_id:freelancer_id}));
    ...
    $(document).on('click', '.edit-project', function(e){
      ...
      if(cpid != '' && typeof(cpid) != 'undefined'){
        $.ajax({
          url: formUrl('admin/freelancer/project/detail/' + cpid, {freelancer_id:freelancer_id}),
          type: 'post',
          data: {view: 1},
          dataType: 'json',
          beforeSend: function() {
          ...
          success: function(res) {
            if(res.success) {
              ...
              $('#formProject').attr('action', formUrl('admin/freelancer/project/edit/' + cpid, {freelancer_id:freelancer_id}));
    ...
    $(document).on('click', '.delete-project', function(e){
      ...
      $('#formDeleteProject').submit(function(e){
        ...
        var button_txt = $form.find('button[type=submit]').html();
        $.ajax({
          url: formUrl('admin/freelancer/project/delete/' + cpid, {freelancer_id:freelancer_id}),
          type: 'post',
          dataType: 'json',
          beforeSend: function() {
            $form.find('button[type=submit]').html(loading_txt).attr('disabled', true);
