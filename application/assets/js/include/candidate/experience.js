$(function(){
    ...
    function loadExperiences() {
      $.ajax({
        url: base_url + 'candidate/experience',
        type: 'post',
        dataType: 'json',
        beforeSend: function() {
        ...
        $.each(experiences.data, function(ci, experience){
          $('#work-experience-block').append('<div class="experience-section">' +
            '<div class="btn-action-block">' +
              '<button type="button" data-cweid="'+ experience.candidate_experience_id +'" class="btn btn-primary alert-primary edit-experience">' +
                '<i data-feather="edit-2"></i>' +
              '</button>' +
              '<button type="button" data-cweid="'+ experience.candidate_experience_id +'" class="btn btn-danger alert-danger delete-experience">' +
    ...
    $('#add-experience').click(function(e){
      ...
      $('#formExperience').attr('action', base_url + 'candidate/experience/add');
    ...
    $(document).on('click', '.edit-experience', function(e){
      ...
      if(cweid != '' && typeof(cweid) != 'undefined'){
        $.ajax({
          url: base_url + 'candidate/experience/detail/' + cweid,
          type: 'post',
          data: {view: 1},
          dataType: 'json',
          beforeSend: function() {
          ...
          success: function(res) {
            if(res.success) {
              ...
              $('#formExperience').attr('action', base_url + 'candidate/experience/edit/' + cweid);
    ...
    $(document).on('click', '.delete-experience', function(e){
      ...
      $('#formDeleteExperience').submit(function(e){
        ...
        var button_txt = $form.find('button[type=submit]').html();
        $.ajax({
          url: base_url + 'candidate/experience/delete/' + cweid,
          type: 'post',
          dataType: 'json',
          beforeSend: function() {
            $form.find('button[type=submit]').html(loading_txt).attr('disabled', true);
