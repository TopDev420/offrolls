            ...
            if($.isArray(jobs) && jobs.length > 0){
                $.each(jobs, function(jkey,job){
                    ...
                    if(job.isCompleted == 1) {
                        ...
                        complete_action = '<a class="button button-default d-none" href="'+ job.complete +'" data-srow-id="'+ jkey +'"  type="button">Complete</a>';
                    }
                    ...
                    if(job.isApplied == 1 && job.isShortlisted == 1){
                        ...
                        schedule_action = '<a class="button button-default d-none" href="'+ job.schedule +'" data-srow-id="'+ jkey +'"  type="button">Schedule</a>';
                    }
                    ...
                    if(job.isShortlisted == 1){
                        ...
                        shortlist_action = '<a class="button button-default d-none" href="'+ job.shortlist +'" data-srow-id="'+ jkey +'"  type="button">Shortlist</a>';
                    }
