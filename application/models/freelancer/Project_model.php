...
class Project_model extends CI_Model {
    ...
    public function getProjects($freelancer_id) {
		$this->db->select('freelancer_project.*');
        $this->db->from('freelancer_project');
	...
	public function getProject($project_id, $data=array()) {
		...
		//Filter Condition
		$condition = array();
		$condition['freelancer_project_id'] = $project_id;
	...
	public function addProject($freelancer_id, $data=array()){
		$insert_data = array(
		...
		$this->db->insert('freelancer_project', $insert_data);
	...
	public function editProject($project_id, $data=array()){
		...
		$this->db->where('freelancer_project_id', $project_id);
		$result = $this->db->update('freelancer_project', $update_data);
		return $result;
	}
	...
	public function deleteProject($project_id, $data=array()){
		...
		$result = $this->db->delete('freelancer_project', $condition_data);
		return $result;
	}
