...
<header class="header header--signin <?php echo $static ? 'page' : 'two-line'; ?> " data-sticky="false">
  <div class="header__left">
    <a class="ps-logo" href="<?php echo base_url(); ?>" style="position: relative;">
      <img src="<?php echo base_url('application/assets/images/img/Offrolls-logo.png'); ?>" alt="">
      <span style="position: absolute; bottom: -0.15rem; right: 0.5rem; color: #285C7F; font-size:1.2rem">Beta</span>
    </a>
  </div>
