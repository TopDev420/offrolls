    ...
    <div class="alice-bg section-padding">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="company-details" style="background-color: #EAEAEA;">
              <div class="title-and-info">
                <div class="title">
                  ...
                  <div class="title-body">
                    ...
                    <div class="info">
                      <?php if($company['company_category']){ ?><span class="company-type" style="background-color: #EEEAE3; padding: 5px;"><i data-feather="briefcase" style="color: #36A15D;"></i><?php echo $company['company_category']; ?></span><?php } ?>
                      <?php if($company['city']){ ?><span class="office-location" style="background-color: #EEEAE3; padding: 5px;"><i data-feather="map-pin" style="color: #36A15D;"></i><?php echo $company['city']; ?></span><?php } ?>
                    </div>
                  </div>
                </div>
                <div class="download-resume">
                  <!--<a href="#" class="save-btn"><i data-feather="heart"></i>Save</a>-->
                  <a href="#" style="background-color: #2C8F60 !important;"><?php echo $company['total_jobs']; ?> Open Positions</a>
                </div>
              </div>
