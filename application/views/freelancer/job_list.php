        ...
        <div class="container" id="card-body-blocks">
            <div class="ps-section__container">
                <div class="ps-section__content">
                    <h3 class="ps-section--heading1 ps-padrt-md-100">My Projects</h3>
                    <div class="ps-padrt-md-100">

                        <!-- Proposal -->
                        <div class="jy-card card mb-5 border-0" id="myjobs-proposals">
                            <div class="card-body p-0">
                                <h4 class="ps-heading--2">Proposals</h4>
                         ...
                         <!-- SavedProjects -->
                        <div class="jy-card card mb-5 border-0" id="myjobs-saved">
                            <div class="card-body p-0">
                                <h4 class="ps-heading--2">Saved Projects</h4>
                                <div class="manage-job-container">
                                    <div class="pb-4 jobs-block">
                                        <div class="job-items" data-timeline-loader="true"></div>
                                    </div>
                        ...
                        <div class="jy-card card mb-5 border-0" id="myjobs-accepted">
                            <div class="card-body p-0">
                                <h4 class="ps-heading--2">Accepted Jobs</h4>
                                <div class="manage-job-container">
                                    <div class="pb-4 jobs-block">
                                        <div class="job-items" data-timeline-loader="true"></div>
                                    </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>application/assets/js/include/freelancer/job_applied.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>application/assets/js/include/freelancer/job_saved.js"></script>
