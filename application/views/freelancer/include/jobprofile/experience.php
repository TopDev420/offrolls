<div class="jy-card card experience dashboard-section details-section p-0 card-shadow mt-0 mb-5" id="nav-experiences" style="border-radius: 3px;">
  <div class="d-block card-header p-3 clearfix">
    <h5 class="mb-0 font-500 d-inline-block card-title"><i data-feather="briefcase"></i>Work Experience <span class="total--experience"></span></h5>
    <!-- Button trigger modal -->
    <button type="button" class="btn btn-default btn-lg float-right" id="add-experience">
...
<!-- Delete Modal -->
  <div class="modal fade modal-delete" id="modal-delete-experience" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body">
          <h4><i data-feather="trash-2" class="m-3"></i>Delete Experience</h4>
...
<?php $this->document->addScript(base_url('application/assets/js/include/freelancer/experience.js'), 'footer'); ?>
