<div class="personal-information dashboard-section last-child details-section" id="nav-career-details">
  <div class="d-block">
    ...
    <button type="button" class="btn btn-primary edit-resume" id="edit-desired-career-details">
...
<?php $this->document->addScript(base_url('application/assets/js/include/candidate/desired_career_detail.js'), 'footer'); ?>
<script>
  $(function(){
    //Salary Package
