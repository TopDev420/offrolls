...
<div class="experience dashboard-section details-section" id="nav-projects">
  <div class="d-block">
    <h4><i data-feather="grid"></i>Projects</h4>
    <!-- Button trigger modal -->
    <button type="button" class="btn btn-primary edit-resume" id="add-project">
      <i data-feather="plus"></i>
    </button>
  </div>

  <p>Add details about projects you have done in college, internship or at work.</p>
  <div id="project-block" data-timeline-loader="true">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="background-color: #EAEAEA;">
        <div class="modal-body">
          <div class="title">
            <h4><i data-feather="briefcase"></i>Project</h4>
          </div>
          <div class="content">
            <form action="#" id="formProject" method="post">
              ...
              <div class="row">
                <div class="col-sm-9">
                  <div class="buttons">
                    <button class="ps-btn small">Save</button>
                    <button class="ps-btn ps-btn--sm ps-btn--white ps-btn--shadow" data-dismiss="modal">Cancel</button>
                  </div>
                </div>
              </div>
            </form>
...
<?php $this->document->addScript(base_url('application/assets/js/include/candidate/project.js'), 'footer'); ?>
