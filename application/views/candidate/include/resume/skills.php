...
<div class="skill-and-profile details-section dashboard-section" id="nav-skills">
  <div class="skill card-section">
    <div class="skill-heading mb-3">
      ...
      <button type="button" class="btn btn-primary edit-resume" id="edit-skills">
                ...
                <div class="row">
                  <div class="col-sm-9">
                    <div class="buttons">
                      ...
                      <button type="button" data-dismiss="modal" class="ps-btn ps-btn--sm ps-btn--white ps-btn--shadow">Cancel</button>
                    </div>
                  </div>
                </div>
              </form>
...
<?php $this->document->addScript(base_url('application/assets/js/include/candidate/skills.js'), 'footer'); ?>