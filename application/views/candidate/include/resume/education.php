<div class="edication-background details-section dashboard-section" id="nav-educations">
  <div class="d-block mb-3">
    ...
    <button type="button" class="btn btn-primary edit-resume" id="add-education">
...
<?php $this->document->addScript(base_url('application/assets/js/include/candidate/education.js'), 'footer'); ?>