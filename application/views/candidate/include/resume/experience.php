<div class="experience dashboard-section details-section" id="nav-experiences">
  <div class="d-block">
    ...
    <button type="button" class="btn btn-primary edit-resume" id="add-experience">
...
<?php $this->document->addScript(base_url('application/assets/js/include/candidate/experience.js'), 'footer'); ?>
