<div class="card border-0 mb-4 alice-bg2">
  <div class="card-body p-5">
    <div class="mt-0 personal-information dashboard-section details-section" id="nav-career-details">    
      <div class="d-block">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <?php foreach($job_types as $job_type) { ?>
                        <label>
                          <input type="radio" name="job_type" class="job-type" value="<?php echo $job_type->category_id; ?>" /> <?php echo $job_type->name; ?>
                        </label>
                      <?php } ?>
...
<?php $this->document->addScript(base_url('application/assets/js/include/admin/candidate/desired_career_detail.js'), 'footer'); ?>
<script>
  $(function(){
    //Salary Package
