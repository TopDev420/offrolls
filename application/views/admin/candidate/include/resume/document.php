      ...
      <div class="download-resume row" id="download-resume">
        ...
        <div class="col-md-6 attachment-block2 d-none">
          <div class="update-file">
            <input type="file">Upload CV <i data-feather="edit-2"></i>
          </div>
...
<script>
  $(function(){
    ...
    function loadResume(){
        $.ajax({
            url: formUrl('admin/candidate/profile/resume', {candidate_id:candidate_id}),
            type: "POST",
            dataType: 'json',
            beforeSend: function(){
    ...
    $(document).on('submit', '#formUploadResume', function(e){
      ...
      var $this = $(this);
      $.ajax({
        url: formUrl('admin/candidate/profile/resume/upload', {candidate_id:candidate_id}),
        type: "POST",
    ...
    $(document).on('click', '#btn-download-resume', function(e){
        ...
        window.open(formUrl('admin/candidate/profile/resume/download', {candidate_id:candidate_id}), "_blank");
    });
