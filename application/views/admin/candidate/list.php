                  ...
                  <?php if ($candidates) { ?>
                    <?php foreach ($candidates as $candidate) { ?>
                      <tr>
                        ...
                        <td class="text-left"><?php echo $candidate['email']; ?></td>
                        <td><?php echo ($candidate['status'] == 1) ? 'Active' : 'Inactive'; ?></td>
                        <td>
                          <a href="<?php echo $candidate['edit']; ?>" class="btn-default"><span class="ti-eye"></span></a>
                        </td>
                      </tr>
                    <?php } ?>
                  <?php } else { ?>
