                      ...
                      <?php if($categories){ ?>
                        <?php foreach($categories as $category) { ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url() . 'admin/category/state/edit/' . $category->category_id; ?>" class="button-default small-xs primary-bg white-text edit-category"><i class="fas fa-pencil-alt"></i></a>
                              <a href="<?php echo base_url() . 'admin/category/state/delete/' . $category->category_id; ?>" class="button-default small-xs  danger-bg white-text delete-category"><i class="fas fa-trash-alt"></i></a>
                            </td>
                          </tr>
                        <?php } ?>
                      <?php } else { ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formAddCategory" method="post" action="<?php echo base_url() . 'admin/category/state/add'; ?>">
