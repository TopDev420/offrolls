                  ...
                  <?php if ($categories) { ?>
                    <?php foreach ($categories as $category) { ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url() . 'admin/category/jobcategory/edit/' . $category->category_id; ?>" class="button-default small-xs primary-bg white-text edit-category"><i class="fas fa-pencil-alt"></i></a>
                          <a href="<?php echo base_url() . 'admin/category/jobcategory/delete/' . $category->category_id; ?>" class="button-default small-xs danger-bg white-text delete-category"><i class="fas fa-trash-alt"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  <?php } else { ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formAddCategory" method="post" action="<?php echo base_url() . 'admin/category/jobcategory/add'; ?>">
  ...
  $(function() {
    $('input[name=\'path\']').autocomplete({
      'source': function(request, response) {
        ...
        if (request.length > 2) {
          $.ajax({
            url: '<?php echo base_url() . 'admin/category/industrytype/autocomplete/'; ?>' + request,
            type: 'post',
            dataType: 'json',
