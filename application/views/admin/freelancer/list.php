                ...
                <tbody>
                  ...
                  <?php if ($freelancers) { ?>
                    <?php foreach ($freelancers as $freelancer) { ?>
                      <tr>
                        <td class="text-left"><?php echo $freelancer['name']; ?></td>
                        <td class="text-left"><?php echo $freelancer['email']; ?></td>
                        <td><?php echo ($freelancer['status'] == 1) ? 'Active' : 'Inactive'; ?></td>
                        <td>
                          <a href="<?php echo $freelancer['edit']; ?>" class="btn-default"><span class="ti-eye"></span></a>
                        </td>
                      </tr>
                    <?php } ?>
                  <?php } else { ?>
